...
# <h1>Draw timing precision comparison for small crystals</h1>
# 
# Data produced by <b>Scintillation_timing_precision_pet1.ipynb</b>.
...
result= pickle.load(open('../data/timing/tprecision_pet_1.p','rb'))
