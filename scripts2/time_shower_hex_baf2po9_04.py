...
data= sim_timing_shower(chexes['baf2po9'], shower[600:800], nep=1000, t0origin=[0,0,20.000000], shdir=-1, showerunit=0.1, mfp=170, print_prog= True)
sfile = basedir+'data/timing/time_geom2_shower_hex_baf2po9_04'
np.save(sfile, data)
