...
data= sim_timing_shower(chexes['csipo9'], shower[800:1000], nep=1000, t0origin=[0,0,19.0], shdir=-1, showerunit=0.1, mfp=170, print_prog= True)
sfile = basedir+'data/timing/time_geom2_shower_hex_csipo9_05'
np.save(sfile, data)
