...
data= sim_timing_shower(chexes['lysopo9'], shower[800:1000], nep=1000, t0origin=[0,0,11.0], shdir=-1, showerunit=0.1, mfp=170, print_prog= True)
sfile = basedir+'data/timing/time_geom2_shower_hex_lysopo9_05'
np.save(sfile, data)
